...
const PulseButton = ({ onClick, text, icon: Icon, secondary = false }) => (
  <motion.button 
    ...
    onClick={onClick}
    className={`${secondary ? 'border-2 border-[#E5D9B6] text-[#D4AF37]' : 'bg-[#D4AF37] text-white shadow-lg'} w-full py-4 rounded-full font-montserrat text-[11px] font-bold tracking-[0.3em] uppercase active:bg-[#002366] active:text-white active:shadow-[0_0_25px_rgba(0,35,102,0.8)] transition-all flex items-center justify-center gap-2`}
      ...
      <AnimatePresence mode="wait">
        ...
        {page === 1 && (
          <GlassCard key="p1">
            ...
            <AnimatedItem delay={0.8} className="flex gap-4 text-[#D4AF37] font-montserrat font-bold">
              {[
            ...
            <AnimatedItem delay={1.0} className="w-full">
        ...
        {page === 2 && (
          <GlassCard key="p2">
            ...
            <AnimatedItem delay={0.5} className="space-y-8 w-full px-4">
            ...
            <AnimatedItem delay={0.8} className="w-full">
        ...
        {page === 3 && (
          <GlassCard key="p3">
            ...
            <AnimatedItem delay={0.5} className="space-y-6 w-full px-4">
            ...
            <AnimatedItem delay={0.8} className="w-full">
              <div className="w-full h-40 rounded-2xl overflow-hidden border border-[#E5D9B6]/50 shadow-md mb-6">
                <iframe 
                  title="Venue" 
