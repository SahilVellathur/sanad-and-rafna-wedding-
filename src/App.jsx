      ...
      <div className="glass-card">
        {!submitted ? (
          <>
            ...
            {rsvp === null ? (
              ...
              <div style={{ textAlign: 'center' }}>
                <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>We are so happy to hear that! 💖</p>
                <p className="cursive">See you there,</p>
                <p>Vellathur Family</p>
                <button className="btn-primary" style={{ marginTop: '2rem' }} onClick={() => setSubmitted(true)}>
                  Finish
                </button>
              </div>
            ) : (
              <div style={{ textAlign: 'center' }}>
                <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>Thank you for letting us know 💕</p>
                <p className="cursive">With love,</p>
                <p>Vellathur Family</p>
              </div>
            )}
          </>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <p>Thank you for your love and blessings</p>
